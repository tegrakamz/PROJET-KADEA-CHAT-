...
async function handleLogin(event) {
    ...
    try {
        ...
        showMessage(error.message || "Impossible de contacter le serveur.");
    } finally {
        setLoading(false);
    }
}

// Active ou désactive l'état de chargement sur le bouton
...
// Bascule entre texte masqué et visible pour le mot de passe
